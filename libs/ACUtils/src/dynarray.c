...
ACUTILS_SYMBOL_ATTRIBUTES PRIVATE_ACUTILS_ST_FUNC size_t private_ACUtils_DynArray_calculateCapacityGeneric(size_t requiredSize, size_t minCapacity, size_t maxCapacity, size_t multiplier) {
