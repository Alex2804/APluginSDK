...
{
    return PRIVATE_APLUGINSDK_PRIVATE_NAMESPACE private_APluginSDK_allocateMemory(size);
}

void APLUGINLIBRARY_NAMESPACE freeMemory(void *ptr)
{
    PRIVATE_APLUGINSDK_PRIVATE_NAMESPACE private_APluginSDK_freeMemory(ptr);
}
